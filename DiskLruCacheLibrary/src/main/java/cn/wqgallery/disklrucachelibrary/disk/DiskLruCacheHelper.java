package cn.wqgallery.disklrucachelibrary.disk;
 ...
 * Created by zdh
 */
public class DiskLruCacheHelper<T> {
    ...
    public T getAsObjects(String key) {
        if (key == null) {
        ...
        try {
            ...
            value = (T) JSON.parseObject(str, clazz.getClass());
        } catch (IOException e) {
            e.printStackTrace();
            try {
                inputStream.close();
